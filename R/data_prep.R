...
dat$sediment_mg_per_l[is.na(dat$sediment_mg_per_l)] <- 1
dat$ammonium_microM[is.na(dat$ammonium_microM)] <- 0.01391
dat$phosphorous_microM[is.na(dat$phosphorous_microM)] <- 0.446
dat$copper_ug_per_l[is.na(dat$copper_ug_per_l)] <- 0.9
dat$mercury_ug._per_l[is.na(dat$mercury_ug._per_l)] <- 0.15
dat$tributyltin_ug_per_l[is.na(dat$tributyltin_ug_per_l)] <- 0.01
dat$zinc_ug_per_l[is.na(dat$zinc_ug_per_l)] <- 5
dat$cadmium_ug_per_l[is.na(dat$cadmium_ug_per_l)] <- 0.11
dat$nitrate_microM[is.na(dat$nitrate_microM)] <- 0.254
