...
hist(log10(dat$sediment_mg_per_l))
hist(log10(dat$ammonium_microM))
hist(log10(dat$phosphorous_microM))
hist(log10(dat$copper_ug_per_l))
hist(log10(dat$tributyltin_ug_per_l))
hist(log10(dat$zinc_ug_per_l))
hist(dat$salinity_psu)
hist(log10(dat$nitrate_microM))
hist(dat$acidification_pH)
hist(log10(dat$tempertaure_degrees_kelvin))
